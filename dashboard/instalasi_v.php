              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				$n++;?>	
				 <tr>
				  ...
				  <td><?=$sqla['nama'];?></td>
				  <td><?=tglindo(date_format($row['tgl_instalasi'], 'Y-m-d'));?> - <?=date_format($row['tgl_instalasi'], 'H:i');?></td>	
				  ...
				  <td><?=$st_instal[intval("0".$row['st_instalasi'])];?></td>
				  <td><?=$row['ket_instalasi'];?></td>
		<!--		  <td>
				  <div class="btn-group">
				  ...
				  <td>
				   <div class="btn-group">
						<a href="instalasi_add.php?id=<?=maxiline($row['id_tb_instalasi'], 'e');?>&s=d&t=u" class="btn btn-info btn-sm dropdown-toggle">Detil<span style="margin-right:6px;"></span><span class="caret" style="margin-right:5px;"></span></a>
					</div>
				  </td> 
                </tr>
				<?}?>
