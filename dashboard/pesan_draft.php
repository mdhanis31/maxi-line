...
//paging
	...
	$result_count = $db->query("SELECT COUNT(DISTINCT codepesan) As total_records FROM tr_pesan WHERE id_user_pengirim = '$_SESSION[id_tb_user]' and st_pesan = '2' and st_hapus_pengirim = '1'");
	...
	where id_user_pengirim = '$_SESSION[id_tb_user]' and st_pesan = '2' and st_hapus_pengirim = '1' order by tgl_data desc OFFSET $offset ROWS FETCH NEXT $total_records_per_page ROWS ONLY";
	$res = $db->query($sql);
      ...
      <div class="row">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li  class="active"><a href="pesan_draft.php"><i class="fa fa-file-text-o"></i> Drafts</a></li>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Draft Pesan</h3>
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
               <table class="table table-hover table-striped">
				  ...
				  <input type="hidden" name="h" value="yd" />
				  <? 
				  if(empty($total)){?>
				   <tr>
                   <td>Belum ada pesan draft</td>
				   </tr>  
				  <?} else {
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="pesan_baca.php?id=<?=maxiline($row['id_tr_pesan'], 'e');?>&p=d">to : <?=$to;?></a></td>
                    <td class="mailbox-subject"><b><a style="color:black;" href="pesan_baca.php?id=<?=maxiline($row['id_tr_pesan'], 'e');?>&p=d"><?=$row['subyek'];?></b> - <?=substr(strip_tags(htmlspecialchars_decode($row['pesan'])), 0, 65);;?>...</a>
                    </td>
