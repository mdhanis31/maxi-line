...
if($_GET['s'] == "d" or $_GET['s'] == "e") { 
	...
	$id_tb_survey = $rowu['id_jns_laporan'];
	...
	$tgllaporan = date_format($row['tgl_survey'], 'd-m-Y');	
    ...
    <section class="content">
		...
		<section class="col-lg-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Laporan Survey</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			...
			<?}?>
				...
				<div class="form-group">
                 ...
                 <select class="form-control select2" data-placeholder="pilih hasil survey" style="width: 100%;" disabled> 
				 <?if($_GET['s'] == "b") {?>
				...
				<div class="form-group">
				  ...
				  <?} else if($_GET['s']=='e') {?>
				  <textarea type="textarea" class="form-control" id="keterangan" name="isi_laporan" <? if ($row['sts_survey'] != 2) {echo "required";} else {echo "disabled";}?> placeholder="Masukkan laporan" ><?=$rowu['isi_laporan'];?></textarea>
				  <?} else {?> 
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
	      ...
	      <input type="hidden" name="id_tb_proses" value="<?=$id_tb_survey?>">
