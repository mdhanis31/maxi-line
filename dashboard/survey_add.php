    ...
    <!--            <div class="form-group">
              ...
              <!-- /.box-body -->
				...
				if($_GET['s']=='b') {
					...
					if($row['sts_survey'] == 1){?>
					<a href="survey_add.php?id=<?=maxiline($id_tb_survey, 'e');?>&s=e&t=u" id="olaole" class="btn btn-primary">Revisi</a>
					<?}
				} if($_GET['s']=='d') {
					if($row['sts_survey'] == 1){?>
					<a href="survey_add.php?id=<?=maxiline($id_tb_survey, 'e');?>&s=e" id="olaole" class="btn btn-primary">Revisi</a> 	
					<?}
				} else if($_GET['s']=='e') {
					if($row['sts_survey'] == 1){
						if(in_array($_SESSION['id_tb_user'], $id_usere) or $_SESSION['level_user'] == '1') {?>
				...
				?>
					<li class="item">
						...
						<div class="product-info">
						  <a href="laporan_survey_add.php?id=<?=maxiline($rowx['id_tb_laporan'], 'e');?>&s=e" class="product-title"><?=$sqlz['nm_user']?>
