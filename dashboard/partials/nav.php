        ...
        <nav class="navbar navbar-static-top">
            ...
            <ul class="nav navbar-nav">
                ...
                <ul class="dropdown-menu">
                    ...
                    ?>				
                        ...
                        <a href="pelaporan_add.php?id=<?=maxiline($sq3['id_tr_pelaporan'], 'e');?>&i=<?=maxiline($sq3['code_pelaporan'],'e')?>">
                            ...
                            <p><?$cutnya = chunk_split($sq3['respon'], 25, "<br>"); 
                ...
                <ul class="dropdown-menu">			
                    ...
                    if($_SESSION['level_user'] == 4 or $_SESSION['level_user'] == 1) {
                ...
                <li>
                <a href="logout.php?id=<?=maxiline($_SESSION['id_tb_user'], 'e');?>"><i class="fa fa-sign-out "></i></a>
                </li>
            </ul>
            </div>
        </nav>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <div class="pull-left info">
                ...
                <a href="user_add.php?i=<?=maxiline($_SESSION['id_tb_user'], 'e');?>&a=b"><i class="fa fa-circle text-success"></i> <?if (!isset($_SESSION['username'])) {echo "guest";} else {
                echo $st_level[intval("0".$_SESSION['level_user'])];}?></a>
            </div>
            </div>
            <!-- search form -->
            ...
            <li class="<?php if ($page == "zonasi") {echo "active";} ?>">
                <a href="lokasi_v.php">
                <i class="fa fa-globe"></i> <span>Lokasi Tiang</span>
                <span class="pull-right-container">
                    <small class="label pull-right bg-green"></small>
                </span>
                </a>
