      ...
      <div class="row">
        <!-- Left col --> 		
          ...
          <div class="box box-primary">
			...
			<!--  Coverage  -->
			<div class="form-group">
                <label for="exampleInputtext">Area Coverage</label>
				<? if ($total!='0') {?>
				<div id="coverage_display" style="border: 1px solid #ccc; padding: 10px; min-height: 100px;"><?
				...
				<br>
				<button type="button" data-toggle="modal" data-target="#vermodal1" class="btn btn-success btn-sm open_modale tomboledit" style="margin-top:1px;" id="<?=$id?>" id2="e"><i class="fa fa-edit"> <span class="tombole">Edit Coverage</span></i></button>
				
				<input type="hidden" id="id_tb_lokasi" class="lokation" name="id_tb_lokasi" value="<?=$row['id_tb_lokasi'];?>" required>
				<?} else {?>
				<div id="coverage_display" style="border: 1px solid #ccc; padding: 10px; min-height: 100px;">				 
				</div>
				<br>
				<button type="button" data-toggle="modal" data-target="#vermodal1" class="btn btn-success btn-sm open_modale" style="margin-top:1px;" id="" id2="b"><i class="fa fa-plus-square"> <span class="tombole">Input Coverage</span> </i></button>				
				<input type="hidden" id="id_tb_lokasi" name="id_tb_lokasi" required>
				<?}?>
				<p></p>
			<!-- end coverage -->
...
<script>  
  $(function () {  
	...
	$(document).on('click','.open_modale',function()
	{
        ...
        // window.location.reload(true); // handled via JS now
		});
	});
</script>
</body>
