...
$qry = $db->query("SELECT * FROM tb_user WHERE id_tb_user = '$_SESSION[id_tb_user]' AND level_user = '$_SESSION[level_user]'");
$res = $db->fetchArray($qry);
?>
...
<script type="text/javascript" language="javascript" src="resources/jquery-1.12.4.js"></script>
<script type="text/javascript" language="javascript" src="resources/jquery.dataTables.min.js"></script>
<script type="text/javascript" language="javascript" src="resources/dataTables.searchHighlight.min.js"></script>
<script type="text/javascript" language="javascript" src="resources/jquery.highlight.js"></script>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                $sql = "SELECT COUNT(id_tb_pendaftaran) AS jml FROM tb_pendaftaran where st_layanan = '8' and referral_by = '$res[referral]'";
                $res = $db->query($sql);
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php
                $sql1 = "SELECT COUNT(id_tb_pendaftaran) AS jml1 FROM tb_pendaftaran where referral_by = '$res[referral]' and DATEADD(dd, 0, DATEDIFF(dd, 0, tgl_data)) = '$sekarang'";
                $res1 = $db->query($sql1);
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <?php
                $sql2 = "SELECT COUNT(id_tb_pendaftaran) AS jml2 FROM tb_pendaftaran where referral_by = '$res[referral]' and st_layanan not in('2','8','9') ";
                $res2 = $db->query($sql2);
