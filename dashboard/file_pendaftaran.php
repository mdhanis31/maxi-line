...
?>
  ...
  <link rel="stylesheet" href="bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
			...
			<div class="modal-header">
				...
				<a data-toggle="modal" href="#myModal2" style="float:right;" class="btn btn-primary <?=$tombul;?>">Tambah file</a>
				...
				<td><?=$rowf['ket_gbr'];?></td>
				<td>
				<a href="file_pendaftaran_.php?id=<?=maxiline($rowf['id_tb_file_pendaftaran'], 'e');?>&i=<?=maxiline($id_tb_pendaftaran, 'e');?>&g=h&token=<?echo $kodeaman;?>" class="btn btn-primary btn-sm <?=$tombul;?>" onclick="return confirm('Hapus file?')"><i class="fa fa-close"></i></a>
				</td>	
				</tr>
				<?}?>
				</tbody>
