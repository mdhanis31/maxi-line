      ...
      <!-- /.box -->
            <div class="box-body border-radius-none">
			  ...
			  <table id="example1" class="table table-bordered table-striped">
				...
				<td align="right">-</td>
				<td align="right">Rp. <?=number_format($sqlb['harga_paket'],0,',','.').",00";?><br><span style="font-size:12px;color:red;">- Rp. <?=number_format($diskon,0,',','.').",00";?><br>Pemakaian layanan hanya <?=$jeda;?> Hari</span></td>
				...
				<tr>
				  ...
				  <td align="right">-</td>
				  <td align="right">Rp. <?=number_format($row1['harga_transaksi'],0,',','.').",00"; if($sqlb['harga_paket'] != $row1['sub_total']) {?><br><span style="font-size:12px;color:red;">- Rp. <?=number_format($diskon,0,',','.').",00";?><br>Pemakaian layanan hanya <?=$row1['jumlah'];?> Hari</span><?}?></td>
