...
//bikin no invoice//
$sqlv = $db->fetchArray($db->query("SELECT MAX(id_tr_invoice) as idinvoice from tr_invoice where tgl_data = '$saiki'"));
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
			   ...
			   <div class="form-group">
				...
				<input class="form-control" value="Layanan Servis & langganan" disabled >				
				</div>
              </div>
			   <div class="form-group">
                <div class="input-group">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
			   ...
			   <div class="form-group">
				...
				<input class="form-control datepicker" name="tgl_invoice" id="datepicker" value="<?=$tglinvoice;?>" <?if(empty($tota) or $ro['sts_invoice'] == 1) { } else {echo "disabled";}?>>				
				</div>
              </div>
			   <div class="form-group">
                <div class="input-group">
				...
				<input class="form-control datepicker" name="tgl_expired" id="datepicker" value="<?=$tglexpired;?>" <?if(empty($tota) or $ro['sts_invoice'] == 1) { } else {echo "disabled";}?>>				
				</div>
              </div>
              <!-- /.form-group -->
            </div>
      ...
      <!-- /.box -->
            <div class="box-body border-radius-none">
			  ...
			  <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?
				 $sqld = "SELECT * FROM tb_potongan where satuan = 'Rp' and jns_potongan = '3' and status ='1'";
				 $resd = $db->query($sqld);
				 $nmpotongan1 = array();
				 $potongan1 = array();
				 ...
				 $sqle = "SELECT * FROM tb_potongan where satuan = '%' and jns_potongan = '3' and status ='1'";
				 $rese = $db->query($sqle);
				 $nmpotongan2 = array();
				 $potongan2 = array();
			...
			<div style="margin-top:50px;">	
			<?if(empty($tota) or $ro['sts_invoice'] == 1) {?>			
			<form action="invoice_3.php" method="post" enctype="multipart/form-data" name="form" id="form3" style="width: 20%; display: contents;">
		 ...
		 <form action="invoice_3.php" method="post" enctype="multipart/form-data" name="form" id="form2" >
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
               <div class="col-md-12">
				<form class="form-horizontal" action="invoice_3.php" method="post" enctype="multipart/form-data" name="form" id="form" role="form" onsubmit="return validateSearch()">
				<?
				if(empty($tota)){?>
				<input type="hidden" name="token" value="<?=$kodeaman?>" />
