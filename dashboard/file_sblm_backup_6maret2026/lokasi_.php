...
$id_alamat = SafeSQL($_POST['id_alamat']);
...
if ($_POST['f'] == 'n'){
    ...
    ?><script>
	  ...
	  exit();  
		...
		values ('$nama', '$nama_area', '$alamat', '$id_alamat', '$id_tb_user', '$kuota', '$tglpasang', '$latitude', '$longitude', '$keterangan_tiang')");
...
$sqla = $db->query ("update tb_lokasi set nama_tiang='$nama', nama_area='$nama_area', alamat_tiang='$alamat', id_v_alamat='$id_alamat', id_tb_user='$id_tb_user', 
