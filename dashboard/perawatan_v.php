  ...
  <div class="content-wrapper">
    ...
    <!--    <small>Control panel</small> -->
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Perawatan / Perbaikan</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				$n++;?>	
				 <tr>
				  ...
				  <td><?=$sqla['nama'];?></td>
				  <td><?=tglindo(date_format($row['tgl_perawatan'], 'Y-m-d'));?> - <?=date_format($row['tgl_perawatan'], 'H:i');?></td>
				  ...
				  <td><?=$st_perawatan[intval("0".$row['st_perawatan'])];?></td>
				  <td><?=$row['ket_perawatan'];?></td>
		<!--		  <td>
				  <div class="btn-group">
				  ...
				  <td>
				   <div class="btn-group">
						<a href="perawatan_add.php?id=<?=maxiline($row['id_tb_perawatan'], 'e');?>&s=d&t=u" class="btn btn-info btn-sm dropdown-toggle">Detil<span style="margin-right:6px;"></span><span class="caret" style="margin-right:5px;"></span></a>
					</div>
				  </td> 
                </tr>
				<?}?>
