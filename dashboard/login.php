...
<div class="login-box">
  ...
  <div class="login-box-body">
	...
	<input type="hidden" name="token" value="<?php echo $kodeaman; ?>" />
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Password" name="password" id="passe">
	...
	<div class="form-row">
      ...
      <div class="row">
        <div class="col-xs-8">
          ...
          <label>
              <input type="checkbox" onclick="myFunction()" style="margin-left: 0px;"><span style="margin-left: 18px;">Show Password</span>
            </label>
          </div>
        </div>
        <!-- /.col -->
	...
	<p class="mb-1" style="margin-top: 10px;">
        <a href="lupa_pass.php" class="text-center">Lupa Password</a>
      </p>
      <p class="mb-1">
