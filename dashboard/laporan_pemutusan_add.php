...
if($_GET['s'] == "d" or $_GET['s'] == "e") { 
	...
	$id_tb_pemutusan = $rowu['id_jns_laporan'];
	...
	$tgllaporan = date_format($row['tgl_pemutusan'], 'd-m-Y');	
    ...
    <section class="content">
          ...
          <div class="box box-primary">
			...
			<?}?>
				...
				<div class="form-group">
                 ...
                 <select class="form-control select2" data-placeholder="pilih hasil pemutusan" style="width: 100%;" disabled> 
				 <?if($_GET['s'] == "b") {?>
				 <option value="">--- Pilih Hasil ---</option>
				 <?}?>
				 <option value="1" <?if($row['st_pemutusan'] == 1) {echo "selected";}?> >Direview</option>
				 <option value="2" <?if($row['st_pemutusan'] == 2) {echo "selected";}?> >Disetujui</option>
				 <option value="3" <?if($row['st_pemutusan'] == 3) {echo "selected";}?> >Ditolak</option>
				</select>
                </div>
				</div>
				</div>
				...
				<div class="form-group">
				  ...
				  <?} else if($_GET['s']=='e') {?>
				  <textarea type="textarea" class="form-control" id="keterangan" name="isi_laporan" <? if ($row['sts_pemutusan'] != 2) {echo "required";} else {echo "disabled";}?> placeholder="Masukkan laporan" ><?=$rowu['isi_laporan'];?></textarea>
				  <?} else {?> 
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
	      ...
	      <input type="hidden" name="id_tb_proses" value="<?=$id_tb_pemutusan?>">
		  <input type="hidden" name="st_proses" value="5">
		  <input type="hidden" name="id_tb_pendaftaran" value="<?=$id_tb_pendaftaran?>">
