(function($) {
		...
		$('#contact-form').validate({
			...
			messages: {
				...
				capjay: {
					...
					number: "Captcha harus berupa angka"
				},
			}
		});
	}
	...
	if($('#registration-form').length) {
		$('#registration-form').validate({
			...
			messages: {
				id_tb_lokasi: "Lokasi harus dipilih",
				alamat: "Alamat harus diisi",
				id_tb_paket: "Paket Berlangganan harus dipilih",
				tipe_identitas: "Tipe identitas harus dipilih",
				no_identitas: {
				...
				email: {
					required: "Email harus diisi",
					email: "Alamat anda tidak valid",
				},
				telp: "No. Telp / WA harus diisi",
				capjay: {
					required: "Captcha harus diisi",
					number: "Captcha harus berupa angka"
				},
				check_snk: "Anda harus setuju dengan S&K untuk melakukan submit"
			}
		});
	}
